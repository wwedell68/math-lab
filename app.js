...
function sumArray(testArray) { //eslint-disable-line
  var result = sumAndMultiply(testArray[0], testArray[1], testArray[2]);
  var answer = result[0];

  var message = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + answer + ' is their sum.';
...
function multiplyArray(multArr) { //eslint-disable-line
  ...
  var multAnswer = [multArr, 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + multArr + '.'];
  return multAnswer;
}
